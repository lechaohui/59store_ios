...
- (void)shareTheDocument
{
    ...
    _shareView = [[HXSShareView alloc] initShareViewWithParameter:parameter
    ...
    _shareView.shareParameter.imageURLStr = @"http://print-identification.oss-cn-hangzhou.aliyuncs.com/78d4f277589f3e9807321fe3db6380221474465479036.png";
...
{
    if(!_shareBarButton) {
        UIImage *shareImage = [HXSPrintModel imageFromNewName:@"ic_shape"];
