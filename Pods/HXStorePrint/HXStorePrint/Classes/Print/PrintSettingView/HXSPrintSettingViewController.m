...
- (void)initTheMiddleView
{
    ...
    switch (_myPrintOrderEntity.archiveDocTypeNum)
    {
        ...
        {
            [_printDocumentLogoImageView setImage:[HXSPrintModel imageFromNewName:@"img_print_pdf"]];
            break;
        }
        case HXSDocumentTypeDoc:
        {
            [_printDocumentLogoImageView setImage:[HXSPrintModel imageFromNewName:@"img_print_word"]];
            break;
        }
        ...
        case HXSDocumentTypeImageWEBP:
        {
            ...
            [_printDocumentLogoImageView sd_setImageWithURL:url placeholderImage:[HXSPrintModel imageFromNewName:@"img_print_picture"]];
            break;
        }
        case HXSDocumentTypePPT:
        {
            [_printDocumentLogoImageView setImage:[HXSPrintModel imageFromNewName:@"img_print_ppt"]];
            break;
        }
    }
...
- (void)initTheCollectionView
{
    ...
    [_mainCollectionView registerNib:[UINib nibWithNibName:NSStringFromClass([HXSPrintSettingPrintReduceCell class]) bundle:bundle] forCellWithReuseIdentifier:NSStringFromClass([HXSPrintSettingPrintReduceCell class])];
    [_mainCollectionView registerNib:[UINib nibWithNibName:NSStringFromClass([HXSPrintSettingPagesModifyCell class]) bundle:bundle] forCellWithReuseIdentifier:NSStringFromClass([HXSPrintSettingPagesModifyCell class])];
    [_mainCollectionView registerNib:[UINib nibWithNibName:NSStringFromClass([HXSPrintSettingHeaderView class]) bundle:bundle] forSupplementaryViewOfKind:UICollectionElementKindSectionHeader withReuseIdentifier:NSStringFromClass([HXSPrintSettingHeaderView class])];
}
...
- (IBAction)editConfirmAction:(id)sender
{
    ...
    if (self.delegate
        && [self.delegate respondsToSelector:@selector(confirmCartWithOrderItem:andWithPrintDownloadsObjectEntity:)]) {
...
- (void)removedFromSuperView
{
    if (SYSTEM_VERSION_GREATER_THAN(@"8.0")) {
        ...
        [self.view mas_remakeConstraints:^(MASConstraintMaker *make) {
            make.top.equalTo(self.view.superview.mas_bottom);
