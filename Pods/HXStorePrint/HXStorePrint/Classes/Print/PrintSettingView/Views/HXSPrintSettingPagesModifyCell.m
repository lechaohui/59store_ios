...
- (void)checkTheCurrentPrintNumsAndSettingTheButton
{
    ...
    if(currentPrintNums <= DEFAULT_PRINTNUMS) {
        [_decreaseButton setImage:[HXSPrintModel imageFromNewName:@"ic_print_minus_bukedianji"]
                         forState:UIControlStateNormal];
    } else {
        [_decreaseButton setImage:[HXSPrintModel imageFromNewName:@"ic_print_minus_normal"]
                         forState:UIControlStateNormal];
    }
}
