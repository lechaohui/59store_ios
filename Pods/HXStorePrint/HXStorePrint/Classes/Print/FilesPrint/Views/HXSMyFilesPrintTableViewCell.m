...
- (void)refreshTheCell
{
    ...
    [_documentLogoImageView setImage:[HXSPrintModel imageFromNewName:@"img_print_newadd"]];
    
    [_contentLabel setText:@""];
    [_timeLabel setText:@""];
    
    [_addToCartButton setHidden:NO];
    [_addToCartButton setImage:[HXSPrintModel imageFromNewName:@"btn_choose_normal"] forState:UIControlStateNormal];
...
- (void)initTheTimeLabelAndNeedReloadUploadButton
{
    ...
    switch (_entity.uploadType) {
        case kHXSDocumentDownloadTypeUploading:
        {
            [_documentLogoImageView setImage:[HXSPrintModel imageFromNewName:@"img_print_add"]];
            ...
            NSString *gifPath = [bundle pathForResource:@"waveupload"
                                                 ofType:@"gif"];
        ...
        case kHXSDocumentDownloadTypeUploadSucc:
        {
            switch (_entity.archiveDocTypeNum) {
                ...
                {
                    [_documentLogoImageView setImage:[HXSPrintModel imageFromNewName:@"img_print_pdf"]];
                    break;
                }
                case HXSDocumentTypeDoc:
                {
                    [_documentLogoImageView setImage:[HXSPrintModel imageFromNewName:@"img_print_word"]];
                    break;
                }
                ...
                case HXSDocumentTypeImageWEBP:
                {
                    ...
                    [_documentLogoImageView sd_setImageWithURL:url placeholderImage:[HXSPrintModel imageFromNewName:@"img_print_picture"]];
                    
                    break;
                }
                case HXSDocumentTypePPT:
                {
                    [_documentLogoImageView setImage:[HXSPrintModel imageFromNewName:@"img_print_ppt"]];
                    break;
                }
            }
            ...
            {
                [_addToCartButton setImage:[HXSPrintModel imageFromNewName:@"btn_choose_blue"] forState:UIControlStateNormal];
            }
            else
            {
                [_addToCartButton setImage:[HXSPrintModel imageFromNewName:@"btn_choose_normal"] forState:UIControlStateNormal];
        ...
        case kHXSDocumentDownloadTypeUploadFail:
        {
            [_documentLogoImageView setImage:[HXSPrintModel imageFromNewName:@"img_print_jiazaishibai"]];
...
- (void)addToCartButtonAnimation
{
    if(!_entity.isFirstFinishedUpload) {
        ...
        _addToCartWidthConstraint.constant = 25;
        _addToCartHeightConstraint.constant = 25;
