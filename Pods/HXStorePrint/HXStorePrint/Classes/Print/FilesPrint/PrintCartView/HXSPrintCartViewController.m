...
@interface HXSPrintCartViewController ()<HXSPrintSettingViewControllerDelegate,
                                         HXSPrintShopListViewControllerDelegate>

/**店铺名称*/
@property (weak, nonatomic) IBOutlet UILabel                        *shopNameLabel;
@property (weak, nonatomic) IBOutlet UIImageView                    *shopClickArrowImageView;
...
- (void)onClickTopView:(UITapGestureRecognizer *)tap
{
    if (self.hasDisplayShopInfoView) {
        ...
        [_shopClickArrowImageView setImage:[HXSPrintModel imageFromNewName:@"ic_arrow_under_gray"]];
    } else {
        __weak typeof(self) weakSelf = self;
        [_shopClickArrowImageView setImage:[HXSPrintModel imageFromNewName:@"ic_arrow_up_gray"]];
...
- (void)fetchShopEntityAndCheckIsClosedNetworking
{
    ...
    [HXSPrintModel fetchShopInfoWithSiteId:manager.currentSite.site_id
                                  ...
                                  complete:^(HXSErrorCode status, NSString *message, HXSShopEntity *shopEntity)
     {
         ...
         [weakSelf jumpToCheckOutVCAction];
     }];
}
 ...
 *  @param sender
 */
- (IBAction)changeShopAction:(id)sender
{
    __weak __typeof(self)weakSelf = self;
...
- (void)selectShopEntity:(HXSShopEntity *)entity
{
    ...
    if(![HXSShopManager shareManager].currentEntry) {
        ...
        [[HXSShopManager shareManager] setCurrentEntry:dormEntry];
    }
    
    [[HXSShopManager shareManager].currentEntry setShopEntity:entity];
    [self initTheShopName];
    [self fetchThePrintSettingNetworking];
