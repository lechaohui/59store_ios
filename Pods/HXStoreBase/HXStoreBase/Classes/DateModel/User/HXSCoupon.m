...
{
    NSDictionary *itemMapping = @{@"type":           @"type",
                                  @"couponCode":     @"code",
...
- (NSString *) getExpireString {
    return [NSString stringWithFormat:@"%@-%@", [NSDate formatDate:[NSDate dateWithTimeIntervalSince1970:self.activeTime.integerValue] style:HXFormatDateStylePointDay], [NSDate formatDate:[NSDate dateWithTimeIntervalSince1970:self.expireTime.integerValue] style:HXFormatDateStylePointDay]];
}
