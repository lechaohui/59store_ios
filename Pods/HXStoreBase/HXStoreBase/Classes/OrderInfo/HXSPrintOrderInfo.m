...
{
    NSDictionary *orderMapping = @{@"freeAmountDoubleNum":       @"free_amount",
                                   ...
                                   @"itemsArr":                  @"items",
                                   @"isConsistentNum":           @"is_consistent",};
    
    return [[JSONKeyMapper alloc] initWithModelToJSONDictionary:orderMapping];
}
