...
typedef enum : NSUInteger {
    ...
    kHXSOrderTypePrint         = 8, // 云印店
    kHXSOrderTypeCharge        = 9, // 充值订单
    kHXSOrderTypeInstallment   = 10, // 分期购
    kHXSOrderTypeEncashment    = 11, // 取现订单
    kHXSOrderTypeStore         = 12, // 云超市
    kHXSOrderTypeB2C                        = 13, // 品牌馆
    kHXSOrderTypeActivityFolivora           = 14, // 秒杀活动
    kHXSOrderTypeHuafei                     = 15, // 充话费流量
    kHXSOrderTypeLiuliang                   = 16, // 充话费流量
    kHXSOrderTypeGame                       = 17, // 充游戏
    kHXSOrderTypeYikatong                   = 18, // 充一卡通
    kHXSOrderTypeNewBox                     = 19, // 零食盒子
    kHXSOrderTypeOneDream                   = 20, // 一元夺宝
    kHXSOrderTypePrintDoc                   = 21, // 云印店
    kHXSOrderTypePrintPhoto                 = 22, // 云印店
    kHXSOrderTypeMK                         = 23, // 约团
    kHXSOrderTypeMKGroup                    = 24, // 约团
    kHXSOrderTypeMKSiteGroup                = 25, // 约团
} HXSOrderType;
...
typedef NS_ENUM(NSInteger, HXSStoreInlet){
    ...
    kHXSStoreInletGroupBuySeller      = 11, // 约团卖家banner
    kHXSStoreInletGroupBuyCustomer    = 12, // 约团用户端首页banner
    kHXSStoreInletFocus               = 13, // 首页下方周围同学在关注
    kHXSStoreInletDiscoverTopNew      = 14, // app5.1发现页上
    kHXSStoreInletDiscoverMiddleNew   = 15, // app5.1发现页中
    kHXSStoreInletDiscoverDownNew     = 16, // app5.1发现页下
    kHXSStoreInletTabBarFirst         = 17, // app5.1tab1
    kHXSStoreInletTabBarSecond        = 18, // app5.1tab2
    kHXSStoreInletTabBarThird         = 19, // app5.1tab3
    kHXSStoreInletTabBarForth         = 20, // app5.1tab4
    kHXSStoreInletCommentTop          = 21, // app5.1评价完成界面上方
    kHXSStoreInletGoodsFreePostage    = 22, // app5.2首页包邮好货
    kHXSStoreInletYeDormListTop       = 23, // app5.2夜猫店列表上方
    kHXSStoreInletYeFreePrintPicTop   = 24  // app5.2免费打图片活动广告
};
