...
@implementation HXSAddressSelectionControlStyle

+ (HXSAddressSelectionControlStyle*)defaultStyle
{
    
    HXSAddressSelectionControlStyle *style = [[HXSAddressSelectionControlStyle alloc]init];
...
@interface HXSAddressSelectionControl (){
...
@implementation HXSAddressSelectionControl
...
- (void)setup
{
    _style = [HXSAddressSelectionControlStyle defaultStyle];
...
- (void)setStyle:(HXSAddressSelectionControlStyle *)style
{
    _style = style;
