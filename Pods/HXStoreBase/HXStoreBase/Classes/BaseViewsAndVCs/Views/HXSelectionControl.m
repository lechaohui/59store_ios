...
@implementation HXSelectionControlStyle
...
@implementation HXSelectionControl
...
- (void)setup
{
    ...
    _style = [HXSelectionControlStyle defaultStyle];
...
- (void)setStyle:(HXSelectionControlStyle *)style
{
    _style = style;
