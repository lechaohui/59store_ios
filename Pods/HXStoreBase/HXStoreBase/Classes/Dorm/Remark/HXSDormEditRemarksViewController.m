...
static NSInteger const kMaxLengthTextView = 45;
...
- (void)viewDidLoad {
    ...
    _leftWordsLabel.text = [NSString stringWithFormat:@"%lu/%zd", (unsigned long)self.textView.text.length, kMaxLengthTextView];
}
