...
@property(nonatomic,strong)UIButton *placeBut;
...
//    _butBackView = [[UIView alloc] initWithFrame:CGRectMake(-10, 20, 130, 25)];
//    _butBackView.backgroundColor = [UIColor lightGrayColor];
//    _butBackView.layer.cornerRadius = 13;
//    _butBackView.layer.masksToBounds = YES;
//    [self addSubview:_butBackView];
//    _placeLab = [[UILabel alloc] initWithFrame:CGRectMake(10, 2, 80, 20)];
//    _placeLab.backgroundColor = [UIColor clearColor];
//    _placeLab.text = @"北京wwwwwweeeee";
...
//    
//    [_butBackView addSubview:_placeLab];
//    _placeBut = [[UIButton alloc] initWithFrame:CGRectMake(CGRectGetMaxX(_placeLab.frame), 2, 25, 20)];
//    [_placeBut setImage:[UIImage imageNamed:@"ic_downcontent"] forState:UIControlStateNormal];
//    [_butBackView addSubview:_placeBut];
//    
//    
//    //手势
//    UITapGestureRecognizer *tap = [[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(tapAction:)];
//    [_butBackView addGestureRecognizer:tap];
    
    
    
    
//    _placeBut = [[UIButton alloc] initWithFrame:CGRectMake(-10, 20, 120, 25)];
//    [_placeBut setTitle:@"北京" forState:UIControlStateNormal];
//    UIImage *image = [UIImage imageNamed:@"ic_downcontent"];
//    [_placeBut setImage:image forState:UIControlStateNormal];
//    _placeBut.titleLabel.font = [UIFont systemFontOfSize:14];
//    _placeBut.layer.masksToBounds = YES;
//    _placeBut.layer.cornerRadius = 13;
//    _placeBut.titleLabel.textColor = [UIColor whiteColor];
//    //top left buttom right
//    _placeBut.contentEdgeInsets = UIEdgeInsetsMake(0, 15, 0, 0);
//    [_placeBut setBackgroundColor:[UIColor lightGrayColor]];
//    _placeBut.titleEdgeInsets = UIEdgeInsetsMake(0, -_placeBut.titleLabel.bounds.size.width , 0, 0);
//    _placeBut.imageEdgeInsets = UIEdgeInsetsMake(0, _placeBut.currentImage.size.width, 0, 0);
//    // 重点位置结束
//    _placeBut.contentHorizontalAlignment = UIControlContentHorizontalAlignmentLeft;
//    
//    
//    [self addSubview:_placeBut];
