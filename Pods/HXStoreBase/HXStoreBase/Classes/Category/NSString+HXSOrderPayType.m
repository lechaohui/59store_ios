...
+ (NSString *)orderTypeNameStringWithOrderType:(HXSOrderType)orderType
{
    ...
    switch (orderType) {
        ...
        case kHXSOrderTypeB2C:
            orderTypeName = @"品牌馆";
            break;
        
        case kHXSOrderTypeActivityFolivora:
            orderTypeName = @"秒杀活动";
            break;
            
        case kHXSOrderTypeHuafei:
            orderTypeName = @"充话费流量";
            break;
            
        case kHXSOrderTypeLiuliang:
            orderTypeName = @"充话费流量";
            break;
            
        case kHXSOrderTypeGame:
            orderTypeName = @"充游戏";
            break;
            
        case kHXSOrderTypeYikatong:
            orderTypeName = @"充一卡通";
            break;
        ...
        case kHXSOrderTypePrintDoc:
            orderTypeName = @"云印店";
            break;
            
        case kHXSOrderTypePrintPhoto:
            orderTypeName = @"云印店";
            break;
            
        case kHXSOrderTypeMK:
            orderTypeName = @"约团";
            break;
            
        case kHXSOrderTypeMKGroup:
            orderTypeName = @"约团";
            break;
            
        case kHXSOrderTypeMKSiteGroup:
            orderTypeName = @"约团";
            break;
