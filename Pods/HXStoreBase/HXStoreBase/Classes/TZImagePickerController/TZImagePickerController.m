...
- (void)showAlertWithTitle:(NSString *)title {
    ...
    HXSCustomAlertView *alertView = [[HXSCustomAlertView alloc]initWithTitle:@"提醒" message:title leftButtonTitle:@"确定" rightButtonTitles:nil];
    [alertView show];
    /*
    if (iOS8Later) {
...
+ (UIImage *)imageNamedFromMyBundle:(NSString *)name {
    NSString *bundlePath = [[NSBundle mainBundle].resourcePath stringByAppendingPathComponent:@"TZImagePickerController.bundle"];
    
    NSString *imgPath = [bundlePath stringByAppendingPathComponent:[NSString stringWithFormat:@"%@%@",@"TZImagePickerController.bundle/",name]];
