...
- (HXSPhoneIdentificationView *)phoneIdentificationView
{
    if (nil == _phoneIdentificationView) {
        ...
        HXSPhoneIdentificationView *phoneIdentificationView = [[bundle loadNibNamed:@"HXSPhoneIdentificationView"
                                                                              owner:nil
...
- (void)sendIdenfication
{
    ...
    [HXSPhoneIdentificationViewModel sendAuthCodeWithPhone:self.phoneNumberStr
...
- (void)sendVerificationCode:(NSString *)codeStr
{
    ...
    __weak typeof(self) weakSelf = self;
    [HXSPhoneIdentificationViewModel verifAuthCodeWithPhone:self.phoneNumberStr
                                            code:codeStr
                                        complete:^(HXSErrorCode code, NSString *message, NSDictionary *authInfo) {
