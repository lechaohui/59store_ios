...
- (id) initWithLocalDic:(NSDictionary *)dic
{
    ...
    if (self != nil)
    {
        ...
        if (DIC_HAS_NUMBER(dic, @"account_money")) {
            self.accountMoneyDoubleNum = [dic objectForKey:@"account_money"];
        }
    }
...
- (NSDictionary *) encodeAsLocalDic
{
    ...
    if (self.accountMoneyDoubleNum) {
        [dic setObject:self.accountMoneyDoubleNum forKey:@"account_money"];
    }
