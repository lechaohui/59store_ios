...
@implementation HXSPrintPayMentTypeTableViewCell
...
- (void)setSelected:(BOOL)selected animated:(BOOL)animated
{
    ...
    if (selected)
    {
        self.checkImageView.image = [viewModel imageFromNewName:@"btn_choose_blue"];
    }
    else
    {
        self.checkImageView.image = [viewModel imageFromNewName:@"btn_choose_normal"];
    }
}
