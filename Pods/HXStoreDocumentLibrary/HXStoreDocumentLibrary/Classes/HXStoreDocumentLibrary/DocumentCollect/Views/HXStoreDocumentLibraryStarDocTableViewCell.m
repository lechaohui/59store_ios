...
@interface HXStoreDocumentLibraryStarDocTableViewCell()
...
@implementation HXStoreDocumentLibraryStarDocTableViewCell
...
- (void)initPageTableViewCellWithMode:(HXStoreDocumentLibraryDocumentModel *)docModel
{
    ...
    [_optionButton setHitTestEdgeInsets:UIEdgeInsetsMake(-10, -10, -10, -10)];//增加触摸热点范围
