...
//    }
    ...
    UIImage *leftItemImage = [UIImage imageNamed:@"btn_icon_zuofanhui"];
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    [self changeNavigationBarBackgroundColor:[UIColor colorWithHexString:@"fde25c"]
                     ...
                     presentBackButItemImage:[UIImage imageNamed:@"btn_back_normal"]
              ...
              loginCanceled:(void (^)(void))cancelCompletion
{
   ...
   //HXSLoginMainViewController *mainVc = nav.viewControllers[0];
//    NSLog(@"%@",mainVc.childViewControllers);
    
    /*
    HXSLoginViewController *loginVc = nav.childViewControllers[0];
   
    loginVc.completion = completion;
    loginVc.loginCanceled = cancelCompletion;*/
    
    HXSLoginViewController *LoginVC = [[UIStoryboard storyboardWithName:@"Login" bundle:bundle] instantiateViewControllerWithIdentifier:@"HXSLoginViewController"];
    LoginVC.completion = completion;
    LoginVC.loginCanceled = cancelCompletion;
