...
@interface HXSAddressSelectVC ()<HXSAddressDecorationViewDelegate,
                                 UITableViewDelegate,
...
#pragma mark - HXSAddressDecorationViewDelegate
...
- (HXSLocationPosition)currentPosition
{
    if(_city == nil || _city.city_id.intValue < 1) {
        ...
        return PositionSite;
    } else if(_building == nil || _building.buildingNameStr.length < 1){
