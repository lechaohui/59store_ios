...
{
    return [[NSBundle mainBundle] loadNibNamed:NSStringFromClass([HXSOrderConsigneeInfoCell class])
...
- (void)resfresh
{
    ...
    self.remarkLabel.text = [NSString stringWithFormat:@"备注：%@",self.buyerAddress.addressRemarkStr];
