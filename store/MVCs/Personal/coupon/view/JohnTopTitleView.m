...
- (void)setting{
    ...
    NSDictionary* selectedTextAttributes = @{NSFontAttributeName:[UIFont systemFontOfSize:15.0f],
                                             NSForegroundColorAttributeName: [UIColor colorWithHexString:@"fde25c"]};
    ...
    self.lineView.backgroundColor = [UIColor colorWithHexString:@"fde25c"];
...
- (void)setupViewControllerWithFatherVC:(UIViewController *)fatherVC childVC:(NSArray<UIViewController *>*)childVC{
    ...
    self.lineView.frame = CGRectMake(0, _titleHeight - 3,_lineViewWidth, 3);
