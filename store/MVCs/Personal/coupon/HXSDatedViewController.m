...
@interface HXSDatedViewController ()<UITableViewDelegate,UITableViewDataSource,HXSCouponListSectionHeaderViewDelegate>
...
@implementation HXSDatedViewController
