...
- (void)viewDidLoad
{
    ...
    [self.phoneNumberBtn setTitle:HXSConst.phoneNumberStr forState:UIControlStateNormal];
    [self.phoneNumberBtn setTitle:HXSConst.phoneNumberStr forState:UIControlStateSelected];
}
...
{
    NSMutableString * str=[[NSMutableString alloc] initWithFormat:@"telprompt://%@", HXSConst.phoneNumberStr];
