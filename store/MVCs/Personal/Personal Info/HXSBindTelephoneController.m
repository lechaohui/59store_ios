...
- (void)bindTelephoneServiceCallBtnPressed
{
    ...
    NSString *message = [NSString stringWithFormat:@"拨打 %@ 吗?", HXSConst.phoneNumberStr];
    HXSCustomAlertView *alert = [[HXSCustomAlertView alloc] initWithTitle:@"提示" message:message leftButtonTitle:@"取消" rightButtonTitles:@"确定"];
    alert.rightBtnBlock = ^{
        NSString *phoneNumber = [NSString stringWithFormat:@"tel://%@", HXSConst.phoneNumberStr];
