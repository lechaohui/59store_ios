...
@interface HXSComplaintViewController () <UITableViewDelegate, UITableViewDataSource,UIActionSheetDelegate>
...
//    callEntity.nameStr = HXSConst.phoneNumberStr;
//    
//    HXSAction *callAction = [HXSAction actionWithMethods:callEntity
//                                                 handler:^(HXSAction *action) {
//                                                     NSString *phoneNumber = [@"tel://" stringByAppendingString:HXSConst.phoneNumberStr];
...
//    [sheet show];
    ...
    UIActionSheet *sheet = [[UIActionSheet alloc] initWithTitle:@"拨打电话" delegate:self cancelButtonTitle:@"取消" destructiveButtonTitle:nil otherButtonTitles:@"13918180114",@"18930432431",@"13524933959", nil];
...
- (void)actionSheet:(UIActionSheet *)actionSheet clickedButtonAtIndex:(NSInteger)buttonIndex{
    ...
    switch (buttonIndex) {
        case 0:
            ...
            [[UIApplication sharedApplication] openURL:[NSURL URLWithString:@"tel:13918180114"]];
            break;
        case 1:
            [[UIApplication sharedApplication] openURL:[NSURL URLWithString:@"tel:18930432431"]];
            break;
        case 2:
            [[UIApplication sharedApplication] openURL:[NSURL URLWithString:@"tel:13524933959"]];
            break;
        default:
            break;
    }
