...
/** 回复/删除按钮 */
@property (nonatomic, weak) IBOutlet UIButton    *replyOrDeleteButton;
/** 回复内容 */
@property (nonatomic, weak) IBOutlet TTTAttributedLabel     *replyContentLabel;

/** 回复内容高度约束 */
@property (weak, nonatomic) IBOutlet NSLayoutConstraint *replyContentLabelConstraint;

/** 回复按钮点击回调block */
@property (nonatomic, copy) void (^replyActionBlock)();
/** 删除按钮点击回调block */
@property (nonatomic, copy) void (^deleteCommentActionBlock)();
/** 进入评论人中心 */
@property (nonatomic, copy) void (^loadCommentUserCenterActionBlock)();

/** 回复信息 */
@property (nonatomic, strong) HXSComment *commentEntity;
