...
/** 已关注按的话题 */
@property (nonatomic, strong) NSMutableArray      *followedTopics;
...
//推送消息
/** 消息条数 */
@property (nonatomic, strong) NSString *msgBadgeValue;
/** 消息内容 */
@property (nonatomic, strong) NSString *msgContent;
/** 消息图片 */
@property (nonatomic, strong) NSString *msgIconURL;
/** 当前显示的ViewController */
@property (nonatomic, strong) HXSCommunityTagTableDelegate *currentTableViewDelegate;
@property (nonatomic, strong) HXSLocationManager           *locationManager;
/** 话题Model */
@property (nonatomic, strong) HXSCommunityTopicsModel      *topicModel;
...
/** 学校id */
@property (nonatomic, copy  ) NSNumber    *currentSiteId;
