...
@interface HXSShopListViewController () <UITableViewDelegate,
...
- (void)fetchDormentrySlide
{
    ...
    HXSLocationManager *manager = [HXSLocationManager manager];
    [self.shopModel fetchStoreAppEntriesWithSiteId:manager.currentSite.site_id
                                              type:@(kHXSStoreInletYeDormListTop)
