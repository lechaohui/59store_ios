...
- (void)setRecord:(HXSBillRepaymentItem *)record
{
    ...
    _dateLabel.text = [NSDate stringFromDate:_record.repaymentDate formatString:@"yyyy-MM-dd"]; // 还款时间
    ...
    _borrowDateLabel.text = [NSString stringWithFormat:@"借款日期:  %@", [NSDate stringFromDate:_record.installmentDate formatString:@"yyyy-MM-dd"]];
    ...
    _currentRepaymentDateLabel.text = [NSString stringWithFormat:@"本期还款日:  %@", [NSDate stringFromDate:_record.repaymentDate formatString:@"yyyy-MM-dd"]];
